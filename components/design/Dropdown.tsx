...
export default function Dropdown({dropDownName, options} : {dropDownName : string, options : {
  [index : string] : {name : string, href : string}
}}) {
  return (
    <Menu as="div" className="relative inline-block text-left ">
      <div>
        <Menu.Button className="w-auto h-auto text-[20px] font-[Helvetica] font-[500] px-2 py-[3px] rounded-lg hover:animate-navColorFadeLight  dark:hover:animate-navColorFadeDark ">
          {dropDownName}
        </Menu.Button>
      </div>
