...
const SubscriptionProfileSettings = ({userData, push}) => {
  ...
  return (
    <section id="subscriptions-settings-container" className="flex flex-col items-start pl-10 w-full h-full justify-start gap-y-8 pt-10" >
      ...
      <div id="scraper-storage-setting-wrapper" className="relative bg-header-light-bg dark:bg-header-dark-bg rounded-lg p-4 flex flex-col items-start justify-center gap-y-2 w-[90%] max-w-[800px] h-auto min-h-[160px] border-2 border-gray-600 dark:border-gray-300" >
        <h3 id="scraper-storage-setting-heading" className="text-[22px] font-[600]" >Storage</h3>

        <p id="scraper-storage-setting-description" className="text-start text-[16px] font-[400]" >
        ...
        <div id="scraper-storage-setting-wrapper" className="relative w-full h-auto flex items-start min-h-[34px]" >

          <span className="text-[18px] font-[600]" >{`Current: ${userData.api.rate_limit}`}</span>

          <Link href={"/pricing?product=scraper_storage"} rel="noopener noreferrer" target="_blank" id="increase-scraper-storage"
      ...
      <div id="max-runtime-setting-wrapper" className=" relative bg-header-light-bg dark:bg-header-dark-bg rounded-lg p-4 flex flex-col items-start justify-center gap-y-2 w-[90%] max-w-[800px] h-auto min-h-[160px] border-2 border-gray-600 dark:border-gray-300" >
        ...
        <div id="max-runtime-setting-wrapper" className="relative w-full h-auto flex items-start min-h-[34px]" >

          <span className="text-[18px] font-[600]" >{`Current: ${userData.subscription.max_runtime}sec`}</span>

          <Link href={"/pricing?product=max_storage"} rel="noopener noreferrer" target="_blank" id="increase-max-runtime"
            className=" absolute bottom-0 right-0 border-[1px] font-[600] border-black dark:border-gray-200 rounded-lg p-1 px-2 hover:animate-navColorFadeLight dark:hover:animate-navColorFadeDark  " >
            Increase runtime
          </Link>
        </div>
