...
const SubscriptionProfileSettings = ({userData, push}) => {
  ...
  return (
    <section id="subscriptions-settings-container" className="flex flex-col items-start pl-10 w-full h-full justify-start gap-y-8 pt-10" >
      ...
      <div id="not-available-wrapper" className="relative bg-header-light-bg dark:bg-header-dark-bg rounded-lg p-4 flex flex-col items-start justify-center gap-y-2 w-[90%] max-w-[800px] h-auto min-h-[120px] border-2 border-gray-600 dark:border-gray-300" >
      ...
      <div id="rate-limit-setting-wrapper" className="relative bg-header-light-bg dark:bg-header-dark-bg rounded-lg p-4 flex flex-col items-start justify-center gap-y-2 w-[calc(100%-50px)] max-w-[800px] h-auto min-h-[120px] border-2 border-gray-600 dark:border-gray-300" >
        ...
        <p id="rate-limit-setting-description" className="text-start text-[16px] font-[400]" >
          ...
          <br />
          To see how much it costs please visit <Link href="/billing?product=scraper_storage" > <span className="underline font-[600]" >Billing.</span> </Link>
        </p>
      ...
      <div id="max-runtime-setting-wrapper" className=" relative bg-header-light-bg dark:bg-header-dark-bg rounded-lg p-4 flex flex-col items-start justify-center gap-y-2 w-[calc(100%-50px)] max-w-[800px] h-auto min-h-[120px] border-2 border-gray-600 dark:border-gray-300" >
        <h3 id="max-runtime-setting-heading" className="text-[22px] font-[600]" >Rate limit</h3>
        ...
        <p id="max-runtime-setting-description" className="text-start text-[16px] font-[400]" >
          ...
          <br />
          To see how much it costs please visit <Link href="/billing?product=rate-limit" > <span className="underline font-[600]" >Billing.</span> </Link>
        </p>
